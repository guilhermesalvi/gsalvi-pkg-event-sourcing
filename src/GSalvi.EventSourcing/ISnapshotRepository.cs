...
namespace GSalvi.EventSourcing
{
    ...
    public interface ISnapshotRepository<T> where T : Snapshot
    {
        ...
        /// <summary>
        /// Returns a collection T object by its aggregate id.
        /// </summary>
        ...
        /// <summary>
        /// Returns a collection T object by its event type.
        /// </summary>
        ...
        /// <summary>
        /// Provides a query generation functionality for T type.
        /// </summary>
        /// <returns></returns>
        IQueryable<T> GetAll();
    }
